...
const DescriptionSection = () => {
    return <div className="flex flex-col px-4">
        ...
        <h3 className="justify-start text-justify text-sm mt-1">{laporanContent.deskripsiKejadian}</h3>

        <h2 className="font-semibold justify-start text-xl mt-3">Waktu Kejadian</h2>
        <h3 className="justify-start text-justify text-sm mt-1">{laporanContent.tanggalKejadian} Pukul {laporanContent.waktuKejadian}</h3>

        <h2 className="font-semibold justify-start text-xl mt-3">Jenis Kejahatan</h2>
        <h3 className="justify-start text-justify text-sm mt-1">{laporanContent.jenisTindakan}</h3>

        <h2 className="font-semibold justify-start text-xl mt-3">Lokasi Kejadian</h2>
        <h3 className="justify-start text-justify text-sm mt-1">{laporanContent.lokasiKejadian}</h3>
